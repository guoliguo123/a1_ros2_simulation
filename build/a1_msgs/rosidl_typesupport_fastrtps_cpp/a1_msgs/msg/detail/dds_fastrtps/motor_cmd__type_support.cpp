...
#include "a1_msgs/msg/detail/motor_cmd__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const a1_msgs::msg::MotorCmd & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  a1_msgs::msg::MotorCmd & ros_message)
{
  // Member: mode
  cdr >> ros_message.mode;
...
{
  auto typed_message =
    static_cast<const a1_msgs::msg::MotorCmd *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<a1_msgs::msg::MotorCmd *>(
    untyped_ros_message);
...
{
  return &a1_msgs::msg::typesupport_fastrtps_cpp::_MotorCmd__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, a1_msgs, msg, MotorCmd)() {
  return &a1_msgs::msg::typesupport_fastrtps_cpp::_MotorCmd__handle;
}
