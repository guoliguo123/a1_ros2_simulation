...
#include "a1_msgs/msg/detail/imu__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const a1_msgs::msg::IMU & ros_message,
...
{
  auto typed_message =
    static_cast<const a1_msgs::msg::IMU *>(
    untyped_ros_message);
...
{
  return &a1_msgs::msg::typesupport_fastrtps_cpp::_IMU__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, a1_msgs, msg, IMU)() {
  return &a1_msgs::msg::typesupport_fastrtps_cpp::_IMU__handle;
}
