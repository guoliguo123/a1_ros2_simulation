...
#include "a1_msgs/msg/detail/low_cmd__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const a1_msgs::msg::LowCmd & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  a1_msgs::msg::LowCmd & ros_message)
{
  // Member: levelflag
  cdr >> ros_message.levelflag;
  ...
  size_t current_alignment)
{
  ...
  // Member: motorcmd
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        a1_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_MotorCmd(
  ...
  // Member: led
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        a1_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_LED(
        full_bounded, current_alignment);
    }
  }
...
{
  auto typed_message =
    static_cast<const a1_msgs::msg::LowCmd *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<a1_msgs::msg::LowCmd *>(
    untyped_ros_message);
...
{
  return &a1_msgs::msg::typesupport_fastrtps_cpp::_LowCmd__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, a1_msgs, msg, LowCmd)() {
  return &a1_msgs::msg::typesupport_fastrtps_cpp::_LowCmd__handle;
}
