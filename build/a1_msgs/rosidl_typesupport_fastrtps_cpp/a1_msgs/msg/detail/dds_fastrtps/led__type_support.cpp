...
#include "a1_msgs/msg/detail/led__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const a1_msgs::msg::LED *>(
    untyped_ros_message);
...
{
  return &a1_msgs::msg::typesupport_fastrtps_cpp::_LED__handle;
}
