...
#ifndef A1_MSGS__SRV__DETAIL__HIGH_STATE__STRUCT_HPP_
#define A1_MSGS__SRV__DETAIL__HIGH_STATE__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__a1_msgs__srv__HighState_Request __attribute__((deprecated))
#else
# define DEPRECATED__a1_msgs__srv__HighState_Request __declspec(deprecated)
#endif
...
struct HighState_Request_
{
  using Type = HighState_Request_<ContainerAllocator>;

  explicit HighState_Request_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  {
  ...
  explicit HighState_Request_(const ContainerAllocator & _alloc, rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  {
    (void)_alloc;
    if (rosidl_runtime_cpp::MessageInitialization::ALL == _init ||
      rosidl_runtime_cpp::MessageInitialization::ZERO == _init)
  ...
  // pointer types
  using RawPtr =
    a1_msgs::srv::HighState_Request_<ContainerAllocator> *;
  using ConstRawPtr =
    const a1_msgs::srv::HighState_Request_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<a1_msgs::srv::HighState_Request_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<a1_msgs::srv::HighState_Request_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      a1_msgs::srv::HighState_Request_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<a1_msgs::srv::HighState_Request_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<a1_msgs::srv::HighState_Request_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<a1_msgs::srv::HighState_Request_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<a1_msgs::srv::HighState_Request_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__a1_msgs__srv__HighState_Request
    std::shared_ptr<a1_msgs::srv::HighState_Request_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__a1_msgs__srv__HighState_Request
    std::shared_ptr<a1_msgs::srv::HighState_Request_<ContainerAllocator> const>
  ...
  bool operator==(const HighState_Request_ & other) const
  {
...
using HighState_Request =
  a1_msgs::srv::HighState_Request_<std::allocator<void>>;
...
#ifndef _WIN32
# define DEPRECATED__a1_msgs__srv__HighState_Response __attribute__((deprecated))
#else
# define DEPRECATED__a1_msgs__srv__HighState_Response __declspec(deprecated)
#endif
...
// message struct
template<class ContainerAllocator>
struct HighState_Response_
{
  using Type = HighState_Response_<ContainerAllocator>;

  explicit HighState_Response_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : imu(_init)
  {
    if (rosidl_runtime_cpp::MessageInitialization::ALL == _init ||
      rosidl_runtime_cpp::MessageInitialization::ZERO == _init)
    {
      ...
      this->reserve = 0ul;
      this->crc = 0ul;
      this->eeforce.fill(a1_msgs::msg::Cartesian_<ContainerAllocator>{_init});
      std::fill<typename std::array<float, 12>::iterator, float>(this->jointp.begin(), this->jointp.end(), 0.0f);
    }
  }

  explicit HighState_Response_(const ContainerAllocator & _alloc, rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : imu(_alloc, _init),
    ...
    jointp(_alloc)
  {
      ...
      rosidl_runtime_cpp::MessageInitialization::ZERO == _init)
    {
      ...
      this->reserve = 0ul;
      this->crc = 0ul;
      this->eeforce.fill(a1_msgs::msg::Cartesian_<ContainerAllocator>{_alloc, _init});
      std::fill<typename std::array<float, 12>::iterator, float>(this->jointp.begin(), this->jointp.end(), 0.0f);
    }
  }
  ...
  // pointer types
  using RawPtr =
    a1_msgs::srv::HighState_Response_<ContainerAllocator> *;
  using ConstRawPtr =
    const a1_msgs::srv::HighState_Response_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<a1_msgs::srv::HighState_Response_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<a1_msgs::srv::HighState_Response_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      a1_msgs::srv::HighState_Response_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<a1_msgs::srv::HighState_Response_<ContainerAllocator>, Deleter>;
  ...
  template<typename Deleter = std::default_delete<
      a1_msgs::srv::HighState_Response_<ContainerAllocator>>>
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<a1_msgs::srv::HighState_Response_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<a1_msgs::srv::HighState_Response_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<a1_msgs::srv::HighState_Response_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__a1_msgs__srv__HighState_Response
    std::shared_ptr<a1_msgs::srv::HighState_Response_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__a1_msgs__srv__HighState_Response
    std::shared_ptr<a1_msgs::srv::HighState_Response_<ContainerAllocator> const>
  ...
  // comparison operators
  bool operator==(const HighState_Response_ & other) const
  {
...
// alias to use template instance with default allocator
using HighState_Response =
  a1_msgs::srv::HighState_Response_<std::allocator<void>>;
...
struct HighState
{
  using Request = a1_msgs::srv::HighState_Request;
  using Response = a1_msgs::srv::HighState_Response;
};
...
#endif  // A1_MSGS__SRV__DETAIL__HIGH_STATE__STRUCT_HPP_
