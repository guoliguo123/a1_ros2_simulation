...
#include "a1_msgs/msg/detail/led__rosidl_typesupport_fastrtps_c.h"
...
using _LED__ros_msg_type = a1_msgs__msg__LED;
...
static uint32_t _LED__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_a1_msgs__msg__LED(
...
{
  return max_serialized_size_a1_msgs__msg__LED(
    full_bounded, 0);
}
