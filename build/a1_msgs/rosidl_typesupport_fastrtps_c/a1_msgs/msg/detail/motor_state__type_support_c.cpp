...
#include "a1_msgs/msg/detail/motor_state__rosidl_typesupport_fastrtps_c.h"
...
using _MotorState__ros_msg_type = a1_msgs__msg__MotorState;
...
static uint32_t _MotorState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_a1_msgs__msg__MotorState(
...
{
  return max_serialized_size_a1_msgs__msg__MotorState(
    full_bounded, 0);
}
