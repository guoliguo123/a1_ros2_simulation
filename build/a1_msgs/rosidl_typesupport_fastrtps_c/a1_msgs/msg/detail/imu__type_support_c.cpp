...
#include "a1_msgs/msg/detail/imu__rosidl_typesupport_fastrtps_c.h"
...
using _IMU__ros_msg_type = a1_msgs__msg__IMU;
...
static uint32_t _IMU__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_a1_msgs__msg__IMU(
...
{
  return max_serialized_size_a1_msgs__msg__IMU(
    full_bounded, 0);
}
