...
#include "a1_msgs/srv/detail/mode__rosidl_typesupport_fastrtps_c.h"
...
using _Mode_Request__ros_msg_type = a1_msgs__srv__Mode_Request;
...
size_t get_serialized_size_a1_msgs__srv__Mode_Request(
  const void * untyped_ros_message,
...
static uint32_t _Mode_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_a1_msgs__srv__Mode_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_a1_msgs
size_t max_serialized_size_a1_msgs__srv__Mode_Request(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_a1_msgs__srv__Mode_Request(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, a1_msgs, srv, Mode_Request)() {
...
using _Mode_Response__ros_msg_type = a1_msgs__srv__Mode_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_a1_msgs
size_t get_serialized_size_a1_msgs__srv__Mode_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Mode_Response__ros_msg_type * ros_message = static_cast<const _Mode_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_a1_msgs__srv__Mode_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_a1_msgs
size_t max_serialized_size_a1_msgs__srv__Mode_Response(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_a1_msgs__srv__Mode_Response(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, a1_msgs, srv, Mode_Response)() {
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, a1_msgs, srv, Mode)() {
  return &Mode__handle;
}
