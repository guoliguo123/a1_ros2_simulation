...
#ifndef A1_MSGS__SRV__DETAIL__MODE__FUNCTIONS_H_
#define A1_MSGS__SRV__DETAIL__MODE__FUNCTIONS_H_
 ...
 * calls
 * a1_msgs__srv__Mode_Request__init().
...
/**
 * It calls
 * a1_msgs__srv__Mode_Request__fini()
 ...
 * a1_msgs__srv__Mode_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * a1_msgs__srv__Mode_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * a1_msgs__srv__Mode_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_a1_msgs
...
/**
 * It calls
 * a1_msgs__srv__Mode_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_a1_msgs
...
/**
 * It allocates the memory for the array and calls
 * a1_msgs__srv__Mode_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_a1_msgs
...
/**
 * It calls
 * a1_msgs__srv__Mode_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // A1_MSGS__SRV__DETAIL__MODE__FUNCTIONS_H_
