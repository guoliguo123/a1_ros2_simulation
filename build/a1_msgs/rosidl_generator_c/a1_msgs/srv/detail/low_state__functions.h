...
#ifndef A1_MSGS__SRV__DETAIL__LOW_STATE__FUNCTIONS_H_
#define A1_MSGS__SRV__DETAIL__LOW_STATE__FUNCTIONS_H_
...
/// Initialize srv/LowState message.
/**
...
/// Create srv/LowState message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * a1_msgs__srv__LowState_Request__init().
...
/// Destroy srv/LowState message.
/**
 * It calls
 * a1_msgs__srv__LowState_Request__fini()
...
/// Initialize array of srv/LowState messages.
/**
...
/// Finalize array of srv/LowState messages.
/**
 * It calls
 * a1_msgs__srv__LowState_Request__fini()
...
/// Create array of srv/LowState messages.
/**
 * It allocates the memory for the array and calls
 * a1_msgs__srv__LowState_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/LowState messages.
/**
 * It calls
 * a1_msgs__srv__LowState_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * a1_msgs__srv__LowState_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_a1_msgs
...
/**
 * It calls
 * a1_msgs__srv__LowState_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_a1_msgs
...
/**
 * It allocates the memory for the array and calls
 * a1_msgs__srv__LowState_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_a1_msgs
...
/**
 * It calls
 * a1_msgs__srv__LowState_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // A1_MSGS__SRV__DETAIL__LOW_STATE__FUNCTIONS_H_
