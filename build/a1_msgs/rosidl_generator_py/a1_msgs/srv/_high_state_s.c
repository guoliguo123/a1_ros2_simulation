...
bool a1_msgs__srv__high_state__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("a1_msgs.srv._high_state.HighState_Request", full_classname_dest, 41) == 0);
  }
  a1_msgs__srv__HighState_Request * ros_message = _ros_message;
...
{
  /* NOTE(esteve): Call constructor of HighState_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("a1_msgs.srv._high_state");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "HighState_Request");
...
ROSIDL_GENERATOR_C_EXPORT
bool a1_msgs__srv__high_state__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("a1_msgs.srv._high_state.HighState_Response", full_classname_dest, 42) == 0);
  }
  a1_msgs__srv__HighState_Response * ros_message = _ros_message;
  {  // levelflag
  ...
  {  // footposition2body
    ...
    Py_ssize_t size = 4;
    a1_msgs__msg__Cartesian * dest = ros_message->footposition2body;
  ...
  {  // footspeed2body
    ...
    Py_ssize_t size = 4;
    a1_msgs__msg__Cartesian * dest = ros_message->footspeed2body;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!a1_msgs__msg__cartesian__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
...
{
  /* NOTE(esteve): Call constructor of HighState_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("a1_msgs.srv._high_state");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "HighState_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
