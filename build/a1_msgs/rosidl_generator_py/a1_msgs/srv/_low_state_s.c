...
bool a1_msgs__srv__low_state__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("a1_msgs.srv._low_state.LowState_Request", full_classname_dest, 39) == 0);
  }
  a1_msgs__srv__LowState_Request * ros_message = _ros_message;
...
{
  /* NOTE(esteve): Call constructor of LowState_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("a1_msgs.srv._low_state");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "LowState_Request");
...
ROSIDL_GENERATOR_C_EXPORT
bool a1_msgs__srv__low_state__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("a1_msgs.srv._low_state.LowState_Response", full_classname_dest, 40) == 0);
  }
  a1_msgs__srv__LowState_Response * ros_message = _ros_message;
  {  // levelflag
...
{
  /* NOTE(esteve): Call constructor of LowState_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("a1_msgs.srv._low_state");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "LowState_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
