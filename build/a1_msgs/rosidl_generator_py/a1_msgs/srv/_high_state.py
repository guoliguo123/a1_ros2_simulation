...
class Metaclass_HighState_Request(type):
    """Metaclass of message 'HighState_Request'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__high_state__request
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__high_state__request
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__high_state__request
            cls._TYPE_SUPPORT = module.type_support_msg__srv__high_state__request
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__high_state__request
...
class HighState_Request(metaclass=Metaclass_HighState_Request):
    """Message class 'HighState_Request'."""
...
class Metaclass_HighState_Response(type):
    """Metaclass of message 'HighState_Response'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__high_state__response
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__high_state__response
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__high_state__response
            cls._TYPE_SUPPORT = module.type_support_msg__srv__high_state__response
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__high_state__response
...
class HighState_Response(metaclass=Metaclass_HighState_Response):
    """Message class 'HighState_Response'."""
...
class Metaclass_HighState(type):
    """Metaclass of service 'HighState'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'a1_msgs.srv.HighState')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._TYPE_SUPPORT = module.type_support_srv__srv__high_state

            from a1_msgs.srv import _high_state
            if _high_state.Metaclass_HighState_Request._TYPE_SUPPORT is None:
                _high_state.Metaclass_HighState_Request.__import_type_support__()
            if _high_state.Metaclass_HighState_Response._TYPE_SUPPORT is None:
                _high_state.Metaclass_HighState_Response.__import_type_support__()


class HighState(metaclass=Metaclass_HighState):
    from a1_msgs.srv._high_state import HighState_Request as Request
    from a1_msgs.srv._high_state import HighState_Response as Response
