...
bool a1_msgs__msg__imu__convert_from_py(PyObject * _pymsg, void * _ros_message);
PyObject * a1_msgs__msg__imu__convert_to_py(void * raw_ros_message);
bool a1_msgs__msg__motor_state__convert_from_py(PyObject * _pymsg, void * _ros_message);
PyObject * a1_msgs__msg__motor_state__convert_to_py(void * raw_ros_message);
bool a1_msgs__msg__cartesian__convert_from_py(PyObject * _pymsg, void * _ros_message);
...
bool a1_msgs__msg__low_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("a1_msgs.msg._low_state.LowState", full_classname_dest, 31) == 0);
  }
  a1_msgs__msg__LowState * ros_message = _ros_message;
  {  // levelflag
  ...
  {  // commversion
    ...
    assert(PyLong_Check(field));
    ros_message->commversion = (uint16_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // robotid
    ...
    assert(PyLong_Check(field));
    ros_message->robotid = (uint16_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // sn
    ...
    assert(PyLong_Check(field));
    ros_message->sn = PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // bandwidth
    ...
    assert(PyLong_Check(field));
    ros_message->bandwidth = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // imu
    ...
    if (!a1_msgs__msg__imu__convert_from_py(field, &ros_message->imu)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // motorstate
    ...
    Py_ssize_t size = 20;
    a1_msgs__msg__MotorState * dest = ros_message->motorstate;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!a1_msgs__msg__motor_state__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
  ...
  {  // eeforceraw
    ...
    Py_ssize_t size = 4;
    a1_msgs__msg__Cartesian * dest = ros_message->eeforceraw;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!a1_msgs__msg__cartesian__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
  ...
  {  // eeforce
    ...
    Py_ssize_t size = 4;
    a1_msgs__msg__Cartesian * dest = ros_message->eeforce;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!a1_msgs__msg__cartesian__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
  ...
  {  // position
    ...
    if (!a1_msgs__msg__cartesian__convert_from_py(field, &ros_message->position)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // velocity
    ...
    if (!a1_msgs__msg__cartesian__convert_from_py(field, &ros_message->velocity)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // velocity_w
    ...
    if (!a1_msgs__msg__cartesian__convert_from_py(field, &ros_message->velocity_w)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * a1_msgs__msg__low_state__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("a1_msgs.msg._low_state");
  ...
  {  // commversion
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->commversion);
    {
  ...
  {  // imu
    PyObject * field = NULL;
    field = a1_msgs__msg__imu__convert_to_py(&ros_message->imu);
    if (!field) {
      return NULL;
    }
    {
  ...
  {  // motorstate
    ...
    a1_msgs__msg__MotorState * item;
    for (size_t i = 0; i < size; ++i) {
      item = &(ros_message->motorstate[i]);
      PyObject * pyitem = a1_msgs__msg__motor_state__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
  ...
  {  // eeforceraw
    ...
    a1_msgs__msg__Cartesian * item;
    for (size_t i = 0; i < size; ++i) {
      item = &(ros_message->eeforceraw[i]);
      PyObject * pyitem = a1_msgs__msg__cartesian__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
  ...
  {  // position
    PyObject * field = NULL;
    field = a1_msgs__msg__cartesian__convert_to_py(&ros_message->position);
    if (!field) {
      return NULL;
    }
    {
  ...
  {  // velocity
    PyObject * field = NULL;
    field = a1_msgs__msg__cartesian__convert_to_py(&ros_message->velocity);
    if (!field) {
      return NULL;
    }
    {
  ...
  {  // velocity_w
    PyObject * field = NULL;
    field = a1_msgs__msg__cartesian__convert_to_py(&ros_message->velocity_w);
    if (!field) {
      return NULL;
    }
    {
