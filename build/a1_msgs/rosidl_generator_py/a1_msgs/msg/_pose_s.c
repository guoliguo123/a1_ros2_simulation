...
bool a1_msgs__msg__pose__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("a1_msgs.msg._pose.Pose", full_classname_dest, 22) == 0);
  }
  a1_msgs__msg__Pose * ros_message = _ros_message;
  {  // yaw
...
PyObject * a1_msgs__msg__pose__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("a1_msgs.msg._pose");
