...
: ${AMENT_CURRENT_PREFIX:="/root/try/a1_ros2_simulation/install/a1_controller"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/a1_controller/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/a1_controller/environment/path.sh"
