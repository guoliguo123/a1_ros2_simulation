...
static rosidl_typesupport_introspection_c__MessageMember Cartesian__rosidl_typesupport_introspection_c__Cartesian_message_member_array[3] = {
  {
    ...
    offsetof(a1_msgs__msg__Cartesian, x),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(a1_msgs__msg__Cartesian, y),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(a1_msgs__msg__Cartesian, z),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Cartesian__rosidl_typesupport_introspection_c__Cartesian_message_members = {
  ...
  3,  // number of fields
  sizeof(a1_msgs__msg__Cartesian),
