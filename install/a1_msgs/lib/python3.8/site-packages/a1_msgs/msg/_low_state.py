...
class LowState(metaclass=Metaclass_LowState):
    ...
    _fields_and_field_types = {
        ...
        'reserve': 'uint32',
        'crc': 'uint32',
        'eeforceraw': 'a1_msgs/Cartesian[4]',
        'eeforce': 'a1_msgs/Cartesian[4]',
        'position': 'a1_msgs/Cartesian',
        'velocity': 'a1_msgs/Cartesian',
        'velocity_w': 'a1_msgs/Cartesian',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.Array(rosidl_parser.definition.NamespacedType(['a1_msgs', 'msg'], 'Cartesian'), 4),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['a1_msgs', 'msg'], 'Cartesian'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['a1_msgs', 'msg'], 'Cartesian'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['a1_msgs', 'msg'], 'Cartesian'),  # noqa: E501
    )
