...
int main(int argc, char **argv)
{
    ...
    move_publisher = A1_node->create_publisher<gazebo_msgs::msg::ModelState>("/gazebo/set_model_state", 1000);
    ...
    if(def_frame == coord::WORLD)
    {
        ...
        while(rclcpp::ok())
        {
            ...
            model_state_pub.pose.orientation = tf2::createQuaternionMsgFromRollPitchYaw(0, 0, - 2*M_PI*(double)time_ms/period);
